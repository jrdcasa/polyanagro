...
DIRXTC=../01-GROMACS_MSD_ALLATOM/
PSFFILE=confout_unwrap_labeled.psf
TRJXTC=trajout_nojump.xtc
TOPOLTPR=../00-INPUTS/new_topo.tpr
SKIP=1
...
echo 0 0 | gmx trjconv -f ${DIRXTC}/${TRJXTC} -skip ${SKIP} -b ${BTIME} -e ${ETIME} -s ${TOPOLTPR} -o ${PDBOUT}
