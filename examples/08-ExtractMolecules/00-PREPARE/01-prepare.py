...
filename = "./EVOHFrame09_MS.pdb"
pattern = "EVOH_box"
headinfo_file = "./EVOH_headtail.dat"
residueinfo_file = "./EVOH_residues.dat"
...
pdb.write_pdb(filename_pdb=filenamepdb, separate_chains=False)
